...
public class ModBlockLootTableProvider extends LootTableProvider {
    ...
    static class ModBlockLoot implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
        ...
        protected void addTables() {
            dropSelf(WaxableCoral.WAXED_TUBE_CORAL_BLOCK.get());
            dropSelf(WaxableCoral.WAXED_BRAIN_CORAL_BLOCK.get());
            dropSelf(WaxableCoral.WAXED_BUBBLE_CORAL_BLOCK.get());
            dropSelf(WaxableCoral.WAXED_FIRE_CORAL_BLOCK.get());
            dropSelf(WaxableCoral.WAXED_HORN_CORAL_BLOCK.get());

            dropSelf(WaxableCoral.WAXED_TUBE_CORAL.get());
            dropSelf(WaxableCoral.WAXED_BRAIN_CORAL.get());
            dropSelf(WaxableCoral.WAXED_BUBBLE_CORAL.get());
            dropSelf(WaxableCoral.WAXED_FIRE_CORAL.get());
            dropSelf(WaxableCoral.WAXED_HORN_CORAL.get());

            dropSelf(WaxableCoral.WAXED_TUBE_CORAL_FAN.get());
            dropSelf(WaxableCoral.WAXED_BRAIN_CORAL_FAN.get());
            dropSelf(WaxableCoral.WAXED_BUBBLE_CORAL_FAN.get());
            dropSelf(WaxableCoral.WAXED_FIRE_CORAL_FAN.get());
            dropSelf(WaxableCoral.WAXED_HORN_CORAL_FAN.get());

            dropSelf(WaxableCoral.WAXED_TUBE_CORAL_WALL_FAN.get());
            dropSelf(WaxableCoral.WAXED_BRAIN_CORAL_WALL_FAN.get());
            dropSelf(WaxableCoral.WAXED_BUBBLE_CORAL_WALL_FAN.get());
            dropSelf(WaxableCoral.WAXED_FIRE_CORAL_WALL_FAN.get());
            dropSelf(WaxableCoral.WAXED_HORN_CORAL_WALL_FAN.get());
        }
